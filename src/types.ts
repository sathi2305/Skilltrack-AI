...
export interface DashboardData {
  ...
  skillGapSummary: {
    ...
    improvable: number;
    missing: number;
    topMissing: SkillGapAnalysisResult['missingSkills'];
  };
  currentRoadmap: Roadmap | null;
  todayTasks: (RoadmapTask & { weekTitle?: string })[];
...
export interface AdminMetrics {
  ...
  lowReadinessAlerts: number;
  topSkillGaps: { skill: string; studentsMissingCount: number }[];
  popularSkills: { skill: string; studentCount: number }[];
}
